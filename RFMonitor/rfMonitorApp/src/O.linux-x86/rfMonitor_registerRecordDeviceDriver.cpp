...
/* Generated from ../O.Common/rfMonitor.dbd */
...
int rfMonitor_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/long/Epics/apps/RFMonitor";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"rfMonitor_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    rfMonitor_registerRecordDeviceDriver(*iocshPpdbbase);
}
